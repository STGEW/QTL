...
import utime
from consts import PIN_IMU_SDA, PIN_IMU_SCL, IMU_BUS_FREQ
...
class MPU6050:
    ...
    def read_accel(self):
        ...
        self.data['acc']['x'] = self.data['acc']['x'] / ACC_SCLR_2G
        self.data['acc']['y'] = self.data['acc']['y'] / ACC_SCLR_2G
        self.data['acc']['z'] = self.data['acc']['z'] / ACC_SCLR_2G
